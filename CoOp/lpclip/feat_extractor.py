...
from data.oxford_flowers import OxfordFlowers
from data.fgvc_aircraft import FGVCAircraft
from data.dtd import DescribableTextures
from data.eurosat import EuroSAT
from data.stanford_cars import StanfordCars
...
from data.imagenet_sketch import ImageNetSketch
