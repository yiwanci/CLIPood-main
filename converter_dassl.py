import CoOp.data.oxford_pets
import CoOp.data.oxford_flowers
import CoOp.data.fgvc_aircraft
import CoOp.data.dtd
import CoOp.data.eurosat
import CoOp.data.stanford_cars
import CoOp.data.food101
import CoOp.data.sun397
import CoOp.data.caltech101
import CoOp.data.ucf101
import CoOp.data.imagenet
import CoOp.data.imagenet_sketch
import CoOp.data.imagenetv2
import CoOp.data.imagenet_a
import CoOp.data.imagenet_r
